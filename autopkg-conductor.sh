...
autopkg_user_account="rmckellar"
autopkg_user_account_home=$(/usr/bin/dscl . -read /Users/"$autopkg_user_account" NFSHomeDirectory | awk '{print $2}')
recipe_list="/Users/rmckellar/Library/AutoPkg/RecipeRepos/com.github.rmckellar.AutoPkg/recipe_list.txt"
...
slack_webhook="https://hooks.slack.com/services/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"
